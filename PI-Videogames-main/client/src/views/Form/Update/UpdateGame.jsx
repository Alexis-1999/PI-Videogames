                ...
                <div className="createGameContainer">
                    <form className='form' action="" onSubmit={ handleSubmit } >
                        ...
                        <div className="sectionInputCG">
                            ...
                            <textarea name="description" id='descriptionCG' minLength="10" maxLength="300"   className='input' onChange={ handleChange } cols="30" rows="10" required  autoComplete='off' defaultValue={ detail.description } ></textarea>
                        </div>
