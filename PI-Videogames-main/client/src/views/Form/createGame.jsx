                ...
                <div className="createGameContainer">
                    <form className='form' action="" onSubmit={ handleSubmit } >
                        ...
                        <div className="sectionInputCG">
                            ...
                            <textarea name="description" id='descriptionCG' minLength="10" maxLength="300"  className='input' onChange={ handleChange } required  autoComplete='off' placeholder='Type the description...' ></textarea>
                        </div>
